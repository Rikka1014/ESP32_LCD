...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_label_3, 12, 98);
    ...
    lv_obj_set_size(ui->screen_label_TEMP_SET_VAL, 70, 31);
    lv_label_set_text(ui->screen_label_TEMP_SET_VAL, "25.5°");
    ...
    lv_obj_set_style_text_font(ui->screen_label_TEMP_SET_VAL, &lv_font_Antonio_Regular_28, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_align(ui->screen_label_TEMP_SET_VAL, LV_TEXT_ALIGN_RIGHT, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui->screen_label_TEMP_SET_VAL, 0, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_pad_top(ui->screen_label_TEMP_SET_VAL, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_label_7, 158, 117);
    ...
    lv_obj_set_pos(ui->screen_btn_T_SET_sub, 165, 57);
    ...
    lv_obj_set_pos(ui->screen_btn_T_SET_add, 204, 57);
