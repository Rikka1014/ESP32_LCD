...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_label_1, 14, 14);
    lv_obj_set_size(ui->screen_label_1, 79, 32);
    lv_label_set_text(ui->screen_label_1, "U/V");
    lv_label_set_long_mode(ui->screen_label_1, LV_LABEL_LONG_WRAP);

    //Write style for screen_label_1, Part: LV_PART_MAIN, State: LV_STATE_DEFAULT.
    lv_obj_set_style_border_width(ui->screen_label_1, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_1, &lv_font_ArchitectsDaughter_23, LV_PART_MAIN|LV_STATE_DEFAULT);
