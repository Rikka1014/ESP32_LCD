...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_label_HUMI, 92, 142);
    lv_obj_set_size(ui->screen_label_HUMI, 90, 31);
    lv_label_set_text(ui->screen_label_HUMI, "null\n");
    ...
    lv_obj_set_style_radius(ui->screen_label_HUMI, 5, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui->screen_label_HUMI, lv_color_hex(0xffdb00), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui->screen_label_HUMI, &lv_font_Antonio_Regular_28, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_pad_top(ui->screen_label_HUMI, 3, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_sw_MASTER_POWER, 15, 193);
    ...
    lv_obj_set_style_bg_color(ui->screen_sw_MASTER_POWER, lv_color_hex(0xffffff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_dir(ui->screen_sw_MASTER_POWER, LV_GRAD_DIR_NONE, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_width(ui->screen_sw_MASTER_POWER, 2, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_opa(ui->screen_sw_MASTER_POWER, 153, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_color(ui->screen_sw_MASTER_POWER, lv_color_hex(0x00bdff), LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_border_side(ui->screen_sw_MASTER_POWER, LV_BORDER_SIDE_FULL, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_opa(ui->screen_sw_MASTER_POWER, 223, LV_PART_INDICATOR|LV_STATE_CHECKED);
    lv_obj_set_style_bg_color(ui->screen_sw_MASTER_POWER, lv_color_hex(0x878787), LV_PART_INDICATOR|LV_STATE_CHECKED);
    ...
    lv_obj_set_style_bg_color(ui->screen_sw_MASTER_POWER, lv_color_hex(0xf78585), LV_PART_KNOB|LV_STATE_DEFAULT);
    ...
    //Write style for screen_sw_MASTER_POWER, Part: LV_PART_KNOB, State: LV_STATE_FOCUSED.
    lv_obj_set_style_bg_opa(ui->screen_sw_MASTER_POWER, 255, LV_PART_KNOB|LV_STATE_FOCUSED);
    lv_obj_set_style_bg_color(ui->screen_sw_MASTER_POWER, lv_color_hex(0xffffff), LV_PART_KNOB|LV_STATE_FOCUSED);
    lv_obj_set_style_bg_grad_dir(ui->screen_sw_MASTER_POWER, LV_GRAD_DIR_NONE, LV_PART_KNOB|LV_STATE_FOCUSED);
    lv_obj_set_style_border_width(ui->screen_sw_MASTER_POWER, 0, LV_PART_KNOB|LV_STATE_FOCUSED);
    lv_obj_set_style_radius(ui->screen_sw_MASTER_POWER, 10, LV_PART_KNOB|LV_STATE_FOCUSED);
