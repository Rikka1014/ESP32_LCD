...
void setup_scr_screen_1(lv_ui *ui)
{
    ...
    lv_obj_set_style_bg_opa(ui->screen_1, 254, LV_PART_MAIN|LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui->screen_1, lv_color_hex(0x2FDAAE), LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_pos(ui->screen_1_label_1, 71, 49);
    lv_obj_set_size(ui->screen_1_label_1, 100, 32);
    lv_label_set_text(ui->screen_1_label_1, "HAha");
    ...
    lv_obj_set_pos(ui->screen_1_btn_1, 142, 139);
    lv_obj_set_size(ui->screen_1_btn_1, 55, 29);
    // lv_obj_add_flag(ui->screen_1_btn_1, LV_OBJ_FLAG_HIDDEN);
